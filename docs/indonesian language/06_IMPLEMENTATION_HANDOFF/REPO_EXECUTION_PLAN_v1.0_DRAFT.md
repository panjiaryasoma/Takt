...
## Definition of done
Module dianggap selesai ketika schema validates, acceptance tests pass, failure states are defined, provenance/trace exists where required, and no hidden fallback bypasses the contract.
