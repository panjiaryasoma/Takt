...
The product deals with source uncertainty, effort uncertainty, constraint uncertainty and recommendation uncertainty. False precision berbahaya karena user dapat mengubah jadwal nyata berdasarkan output.
