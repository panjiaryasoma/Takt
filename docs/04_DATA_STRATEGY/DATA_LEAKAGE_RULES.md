...
Leakage occurs when evaluation uses information unavailable at prediction time or when related entities cross splits in a way that makes evaluation deceptively easy.
